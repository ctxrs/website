...
<div className="ctx-home-banner" role="heading" aria-level="1">
  <img src="/docs/assets/ctx-readme-banner.png" alt="Search your agent history. Blame code on the agent that wrote it. Map your codebase. Cut noisy tool output." width="1200" height="630" />
</div>
